...
function additem(idi) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/add-cart', idi).then(function (res) {
    console.log(res.data);
    new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
      type: 'success',
      timeout: 2000,
...
function deleteitem(idi) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/delete-cart', idi).then(function (res) {
    console.log(res.data);
    new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
      type: 'success',
      timeout: 1000,
...
var logbtn = document.querySelector("#logbt");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpanipuri"] = self["webpackChunkpanipuri"] || [];
